...
HD_PWD='C:/Users/Ben/lab13/lab13.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RPS_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RPS_main.tcl
