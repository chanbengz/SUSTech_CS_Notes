...
HD_PWD='C:/Users/Ben/lab13/lab13.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RPS_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RPS_main.tcl -notrace
