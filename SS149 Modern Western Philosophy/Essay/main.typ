...
John Locke also suggests that it is possible for matter to think. He didn't claim that matter does truly think, but argues that the possibility still exists @locke-1700.
#quote(attribution: [Locke, _Essay concerning Human Understanding_], block: true)[
...
The valid argument from the text can be summerized as follows:
  + *Premise*: God is perfect and omnipotent.
  + *Premise*: If God is omnipotent, then he could superadd to matter a faculty of thinking, whatever the form of thinking is.
  + *Conclusion*: It is possible for matter to think.
The premise 1 has already proven by Descartes in his Meditations, so it is sound for sure. The premise 2 is also sound, as it is the definition of omnipotent, otherwise God is not omnipotent and therefore, not perfect, which contradicts with the concept of God. Thus, the premises make sense to me. However, the soundness of the conclusion is opposed by Mary Astell. Astell maintains that thinking is an attribute of immaterial substances and cannot be a property of matter @astell-1705.
#quote(attribution: [Astell, _The Christian Religion_], block: true)[
  It is impossible, says [Locke], That the very same Particle of any Body, shou'd have two different Figures and Textures at the same time. Matter and Thought being as incompatible as any two different Figure and Textures whatever; tho' it were too much for me to be Positive on the force of my own Imagination, yet having so good Authority as the Essay of Human Understanding on my side, I will presume to affirm, that it is impossible for, a Solid Substance to have Qualities, Perfections, and Powers, which have no Natural or Visible Connexion with Solidity and Extension; and since there's no Visible Connection between Matter and Thought, it is impossible for Matter to Think. I utterly despair of meeting with a Triangle equal to a Square, and that can Eat and Discourse; and I find it equally impossible for Body to Think. Thought and Extension being as incompatible to the same Substance, as the Properties of a Square and a Triangle at the same time.
]
Astell's argument can be constructed as follows:
  + *Premise*: A single particle of any body cannot have two different figures and textures simultaneously. 
  + *Premise*: Matter and thought are as incompatible as two different figures and textures.
  + *Premise*: There is no visible connection between matter and thought.
  + *Conclusion*: Matter cannot think.
However the counterargument is valid, the soundess of premise 3 is not well supported, which suffers the limitation of current knowledge and experience. Just because we cannot currently observe a connection between matter and thought does not mean that such a connection is impossible. Modern scientific research could reveal mechanisms that brain used to generate thought, which could provide evidence for the connection between matter and thought. Thus, the rejection is not sound to me, and Locke's argument is still valid and sound to me.
